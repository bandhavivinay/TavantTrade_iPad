...
@private
	DFClient* connection;
	NSObject<DFPagedTopicDelegate> *delegate;
	NSString *topicName;
	NSArray* (*toLines)( DFTopicMessage *message );

}

@property(readonly,nonatomic) DFClient* connection;	/**< Get the connection (the client object that created the handler). */
