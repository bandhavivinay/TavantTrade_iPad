...
@interface DFServiceTopicHandler : NSObject<DFTopicListenerDelegate> {
	DFClient *client;
	DFTopicMessage *message;
	NSObject<DFServiceTopicDelegate> *delegate;
	
	NSString *serviceType, *topicCategory;
...
@property(nonatomic, readonly,getter = getTopic) NSString *topic; /**< Topic to which this service is bound */
...
@property(nonatomic, readonly) DFClient *client; /**< Returns the client connection */
