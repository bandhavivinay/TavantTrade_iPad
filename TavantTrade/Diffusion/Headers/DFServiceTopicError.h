...
@interface DFServiceTopicError : NSObject {
	...
	NSString *requestID, *errorMessage, *exceptionMessage, *additionalDetails;
	
}



@property(nonatomic,readonly) DFServiceTopicHandler *handler; /**< Returns the handler that notified the error */
