...
@private
	...
	int							nextServerIndex;
    NSArray						*serverDetails; // Collections of *DFServerDetails
	DFServerDetails			*currentServerDetails;
	BOOL					isAutoAck;
	BOOL					isAutoFailover, isLoadBalance, isCascade;
}
...
@property(nonatomic,retain) NSArray *serverDetails; /**< The pool of DFServerDetails objects  */
